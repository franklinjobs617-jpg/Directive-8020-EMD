...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages: { path: string; priority: number; changefreq: string }[] = [
    ...
    { path: '/best-ending/', priority: 0.9, changefreq: 'weekly' },
    { path: '/choices-consequences/', priority: 0.9, changefreq: 'weekly' },
    { path: '/save-everyone/', priority: 0.9, changefreq: 'weekly' },
    { path: '/all-deaths/', priority: 0.8, changefreq: 'weekly' },
    { path: '/characters/', priority: 0.8, changefreq: 'weekly' },
    { path: '/collectibles/', priority: 0.8, changefreq: 'weekly' },
    { path: '/trophy-guide/', priority: 0.9, changefreq: 'weekly' },
    { path: '/difficulty-guide/', priority: 0.7, changefreq: 'monthly' },
    { path: '/multiplayer/', priority: 0.7, changefreq: 'monthly' },
    { path: '/game-length/', priority: 0.7, changefreq: 'monthly' },
